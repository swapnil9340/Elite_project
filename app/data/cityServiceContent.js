...
const bookingFlows = [
  "Step 1: Send a WhatsApp or Telegram message with your basic preference — city ({CITY}), area, preferred date and duration. Step 2: Within 10 minutes, you receive 3-5 verified {SERVICE_LC} profiles to choose from. Step 3: Pick your preferred match, confirm time and venue. Step 4: Pay 50% advance via UPI. Step 5: Companion arrives at agreed time and location. Step 6: Final 50% paid on arrival.",
  ...
  "The fastest way to book a {SERVICE_LC} in {CITY} is WhatsApp. Tell us your area, time slot, and budget range. We curate matches and share verified profiles privately. Once you confirm and pay 50% advance, the companion is locked in.",
  "{CITY} bookings can be made up to 24 hours in advance, though same-day bookings are also possible if companions are available. The flow: contact via WhatsApp → receive profiles → confirm → pay 50% UPI advance → meeting happens. Total time from inquiry to meeting can be as little as 2-3 hours.",
  "If you prefer email over WhatsApp, that is supported too. The flow remains the same — share your {CITY} requirement, receive verified {SERVICE_LC} profiles, confirm and pay 50% advance, and meet your companion. Email is slower (1-2 hour response time) but suits clients who prefer documented communication.",
];
