    ...
    <div className={`page-shell ${isLoaded ? "loaded" : ""}`}>
      <section className="hero hero-grid">
        <div className="hero-copy-block">
          ...
          <p className="hero-copy animate-fade-in-delay">
            Authentic male companion service for women seeking genuine
            companionship. Available in{" "}
      ...
      <section id="features" className="section alt feature-section">
        <div className="feature-panel">
          <h2>Why Choose Us — Genuine & Trustworthy</h2>
          <p>
            Authentic male companion service across 50+ Indian cities.
            Transparent pricing, no hidden charges, real service. We are
            discreet, professional, and committed to genuine companionship.
          </p>
        ...
        <div className="feature-panel steps-panel">
      ...
      <section id="testimonials" className="section testimonials-section">
        ...
        <div className="testimonial-grid">
          ...
          <div className="testimonial-card">
            <div className="stars">★★★★★</div>
            <p className="quote">
              "First time trying this service in Bangalore. Was nervous but the
              team was very professional. Genuine service, no extra charges.
          ...
          <div className="testimonial-card">
            <div className="stars">★★★★★</div>
            <p className="quote">
              "As a guy looking for genuine companionship, I found this service
              to be authentic and trustworthy. No scams, transparent rates.
              Highly satisfied with the experience."
            </p>
          ...
          <div className="testimonial-card">
            <div className="stars">★★★★★</div>
            <p className="quote">
              "Great service in Kolkata. Very discreet and professional. The
              pricing was transparent with no extra fees. Had a wonderful time
          ...
          <div className="testimonial-card">
            <div className="stars">★★★★★</div>
            <p className="quote">
              "As a male client, I was impressed by the genuine approach. No
              fake profiles or scams. Transparent pricing and professional
