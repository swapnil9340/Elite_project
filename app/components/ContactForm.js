      ...
      <section className="section contact-hero">
        <div className="contact-hero-info">
          ...
          <p className="hero-copy">
            Share your details and preferences below. Your request is sent
            directly to WhatsApp so we can reply fast, discreetly, and with
            personalized support across Bhopal, Indore, Mumbai, Delhi,
            Bangalore and 45+ more Indian cities.
          </p>
      ...
      <section className="section contact-form-section">
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <p>
              Fill in the fields and click the button below. Your message is
              composed automatically and opens in WhatsApp so you can confirm
