...
const PRIORITY_CITIES = [
  ...
  },
  {
    slug: "delhi",
    name: "Delhi",
    tagline: "Capital · South Delhi, CP, Saket, Hauz Khas, GK",
    services: [
      { slug: "callboy-service", name: "Callboy Service" },
      { slug: "gigolo-service", name: "Gigolo Service" },
      { slug: "playboy-service", name: "Playboy Service" },
  ...
  },
  {
    slug: "gurgaon",
    name: "Gurgaon",
    tagline: "Millennium City · Cyber City, Golf Course Road, DLF",
    services: [
      { slug: "callboy-service", name: "Callboy Service" },
      { slug: "gigolo-service", name: "Gigolo Service" },
      { slug: "playboy-service", name: "Playboy Service" },
  ...
  },
  {
    slug: "noida",
    name: "Noida",
    tagline: "Planned NCR · Sector 18, 62, Greater Noida",
    services: [
      { slug: "callboy-service", name: "Callboy Service" },
      { slug: "gigolo-service", name: "Gigolo Service" },
      { slug: "playboy-service", name: "Playboy Service" },
  ...
  },
  {
    slug: "faridabad",
    name: "Faridabad",
    tagline: "Industrial NCR · Sector 14/21, NIT, Greater Faridabad",
    services: [
      { slug: "callboy-service", name: "Callboy Service" },
      { slug: "gigolo-service", name: "Gigolo Service" },
      { slug: "playboy-service", name: "Playboy Service" },
